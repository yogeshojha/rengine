...
ENDPOINT_FIELDS: tuple[QueryField, ...] = (
    ...
    QueryField(
        ...
        type=FieldType.NUMBER,
        group="Location",
        description="How many directories deep the endpoint sits.",
        example="depth:>3",
    ),
    QueryField(
        name="class",
        type=FieldType.ENUM,
        group="Location",
        description="What kind of thing the endpoint serves.",
        example="class:api",
        aliases=("kind",),
    ...
    QueryField(
        ...
        type=FieldType.NUMBER,
        group="Parameters",
        description="How many parameters the endpoint accepts.",
        example="params:>2",
    ),
    QueryField(
        name="interest",
        type=FieldType.ENUM,
        group="Parameters",
        description="Why the endpoint is worth testing, by path or parameter shape.",
    ...
    QueryField(
        ...
        type=FieldType.ENUM,
        group="Evidence",
        description="How the endpoint was discovered. An endpoint may have several.",
...
ENDPOINT_EXAMPLES: tuple[QueryExample, ...] = (
    ...
    QueryExample(
        ...
        description="Administrative paths answering without a login wall",
        group="Attack surface",
    ),
    QueryExample(
        query="is:orphan",
